...
v0.new("<Color=Cyan>Welcome to Hoang Black Hub<Color=/>"):Display();
wait(0.5);
...
v5.Window = function(v134, v135)
	...
	v170.Image = "http://www.roblox.com/asset/?id="   .. tostring(91650061358241) ;
...
v8.Image = "rbxassetid://91650061358241";
v8.Draggable = true;
...
v67:Button("Copy Discord Link", function()
	setclipboard("https://discord.gg/JVjwk5nm");
end);
v67:Seperator("Time");
...
game:GetService("StarterGui"):SetCore("SendNotification", {
	Title = "Hoang Black Hub",
	Text = "Loading...",
	Icon = "rbxthumb://type=Asset&id=91650061358241&w=150&h=150",
	Duration = 10
});
spawn(function()
	while wait() do
