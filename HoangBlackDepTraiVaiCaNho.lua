...
v5.Window = function(v134, v135)
	...
	v170.Image = "http://www.roblox.com/asset/?id="   .. tostring(128504363561748) ;
	...
	v197.Text = "Hoang Tiger Hub 🐯 v0.09";
	v197.TextSize = 17;
					...
					elseif (game:GetService("Workspace").Enemies:FindFirstChild("Snow Lurker") or game:GetService("Workspace").Enemies:FindFirstChild("Arctic Warrior")) then
						for v2610, v2611 in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
							if (((v2611.Name == "Snow Lurker") or (v2611.Name == "Arctic Warrior")) and (v2611.Humanoid.Health > 0)) then
								...
								until game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Hidden Key") or (_G.Rengoku == false) or  not v2611.Parent or (v2611.Humanoid.He